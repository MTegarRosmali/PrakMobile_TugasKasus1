            ...
            items(items = items, itemContent = { item ->
                Row(modifier = Modifier
                    ...
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Nama barber", fontSize = 14.sp)
                        Text(text = item.namabarber, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Tanggal lahir", fontSize = 14.sp)
                        Text(text = item.tanggallahir, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                    ...
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Jenis member", fontSize = 14.sp)
                        Text(text = item.jenismember, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Potongan Harga", fontSize = 14.sp)
                        Text(text = "Rp.${item.potonganharga} ", fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                }
